...
export function TransitionCtaSection() {
  return (
    <section className="py-24 bg-slate-950 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[32rem] w-[32rem] rounded-full bg-gradient-to-tr from-purple-600/20 to-indigo-600/20 blur-3xl pointer-events-none" />
        ...
        <div className="p-10 sm:p-16 rounded-3xl bg-gradient-to-r from-purple-950/90 via-slate-900 to-indigo-950/90 border border-purple-500/50 shadow-2xl shadow-purple-950/60 text-center space-y-8 relative overflow-hidden">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-tight">
              ...
              <span className="bg-gradient-to-r from-purple-400 via-indigo-300 to-indigo-400 bg-clip-text text-transparent">
